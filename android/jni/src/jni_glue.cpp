...
// Resize
extern "C" void Java_com_zengl_SDL_SDLActivity_onNativeResize(
                                    JNIEnv* env, jclass jcls,
                                    jint width, jint height, jint format)
{
...
// Keydown
extern "C" void Java_com_zengl_SDL_SDLActivity_onNativeKeyDown(
                                    JNIEnv* env, jclass jcls, jint keycode)
{
...
// Keyup
extern "C" void Java_com_zengl_SDL_SDLActivity_onNativeKeyUp(
                                    JNIEnv* env, jclass jcls, jint keycode)
{
...
// Touch
extern "C" void Java_com_zengl_SDL_SDLActivity_onNativeTouch(
                                    JNIEnv* env, jclass jcls,
                                    jint touch_device_id_in, jint pointer_finger_id_in,
                                    jint action, jfloat x, jfloat y, jfloat p)
{
...
// Accelerometer
extern "C" void Java_com_zengl_SDL_SDLActivity_onNativeAccel(
                                    JNIEnv* env, jclass jcls,
                                    jfloat x, jfloat y, jfloat z)
{
...
// Quit
extern "C" void Java_com_zengl_SDL_SDLActivity_nativeQuit(
                                    JNIEnv* env, jclass cls)
{
    Java_org_libsdl_app_SDLActivity_nativeQuit(env, cls);
}

extern "C" void Java_com_zengl_SDL_SDLActivity_nativePause(
                                    JNIEnv* env, jclass cls)
{
	Java_org_libsdl_app_SDLActivity_nativePause(env, cls);
}

extern "C" void Java_com_zengl_SDL_SDLActivity_nativeResume(
                                    JNIEnv* env, jclass cls)
{
	Java_org_libsdl_app_SDLActivity_nativeResume(env, cls);
}

extern "C" void Java_com_zengl_SDL_SDLActivity_nativeRunAudioThread(
                                    JNIEnv* env, jclass cls)
{
