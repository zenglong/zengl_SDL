...
ZL_EXP_VOID mySDL_AndroidLog(ZL_EXP_VOID * VM_ARG,ZL_EXP_INT argcount);//sdlAndroidLog
...
ZL_EXP_VOID mySDL_GetWindowSurface(ZL_EXP_VOID * VM_ARG,ZL_EXP_INT argcount); //sdlGetWindowSurface获取主窗口的表面指针
